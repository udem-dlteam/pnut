...
void write_text_section(){
  ...
  write_i32_le(0x00000000); // VM size high. Assuming that code_alloc is less than 4GB
  ...
  write_i32_le(0x00000000); // file size high. Assuming that code_alloc is less than 4GB

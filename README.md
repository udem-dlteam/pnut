...
- As a way to bootstrap a compiler written in C with an executable version that
  is still human readable, for [reproducible builds](#reproducible-builds).
...
This project is funded through [NGI0 Commons Fund](https://nlnet.nl/commonsfund), a fund established by [NLnet](https://nlnet.nl) with financial support from the European Commission's [Next Generation Internet](https://ngi.eu) program. Learn more at the [NLnet project page](https://nlnet.nl/project/Pnut).

...
_encode() {
  ...
  while [ 1 != 0 ] ; do
    ...
    if [ $b2 -lt 0 ] ; then
      printf "%b" "\0$(((_$((_codes + (63 & (b1 << 4)))))/64))$(((_$((_codes + (63 & (b1 << 4)))))/8%8))$(((_$((_codes + (63 & (b1 << 4)))))%8))"
      printf "%b" "\0$(((__EQ__)/64))$(((__EQ__)/8%8))$(((__EQ__)%8))"
      printf "%b" "\0$(((__EQ__)/64))$(((__EQ__)/8%8))$(((__EQ__)%8))"
      break
    else
      printf "%b" "\0$(((_$((_codes + (63 & ((b1 << 4) | (b2 >> 4))))))/64))$(((_$((_codes + (63 & ((b1 << 4) | (b2 >> 4))))))/8%8))$(((_$((_codes + (63 & ((b1 << 4) | (b2 >> 4))))))%8))"
      _getchar b3 
      if [ $b3 -lt 0 ] ; then
        printf "%b" "\0$(((_$((_codes + (63 & (b2 << 2)))))/64))$(((_$((_codes + (63 & (b2 << 2)))))/8%8))$(((_$((_codes + (63 & (b2 << 2)))))%8))"
        printf "%b" "\0$(((__EQ__)/64))$(((__EQ__)/8%8))$(((__EQ__)%8))"
        break
      else
        printf "%b" "\0$(((_$((_codes + (63 & ((b2 << 2) | (b3 >> 6))))))/64))$(((_$((_codes + (63 & ((b2 << 2) | (b3 >> 6))))))/8%8))$(((_$((_codes + (63 & ((b2 << 2) | (b3 >> 6))))))%8))"
        printf "%b" "\0$(((_$((_codes + (63 & b3))))/64))$(((_$((_codes + (63 & b3))))/8%8))$(((_$((_codes + (63 & b3))))%8))"
      fi
    fi
  done
...
_decode() {
  ...
  while _get __t1 ; [ $((c1 = __t1)) -ge 0 ] ; do
    ...
    printf "%b" "\0$(((255 & ((c2 << 4) | (c3 >> 2)))/64))$(((255 & ((c2 << 4) | (c3 >> 2)))/8%8))$(((255 & ((c2 << 4) | (c3 >> 2)))%8))"
    if _get __t1 ; [ $((c4 = __t1)) -lt 0 ] ; then
      break
    fi
    printf "%b" "\0$(((255 & ((c3 << 6) | c4))/64))$(((255 & ((c3 << 6) | c4))/8%8))$(((255 & ((c3 << 6) | c4))%8))"
  done

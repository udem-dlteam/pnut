...
_main() {
  ...
  while [ $k -gt 0 ] ; do
    ...
    printf "%b" "\0$(((__0__ + (((c + (d / 10000)) / 1000) % 10))/64))$(((__0__ + (((c + (d / 10000)) / 1000) % 10))/8%8))$(((__0__ + (((c + (d / 10000)) / 1000) % 10))%8))"
    printf "%b" "\0$(((__0__ + (((c + (d / 10000)) / 100) % 10))/64))$(((__0__ + (((c + (d / 10000)) / 100) % 10))/8%8))$(((__0__ + (((c + (d / 10000)) / 100) % 10))%8))"
    printf "%b" "\0$(((__0__ + (((c + (d / 10000)) / 10) % 10))/64))$(((__0__ + (((c + (d / 10000)) / 10) % 10))/8%8))$(((__0__ + (((c + (d / 10000)) / 10) % 10))%8))"
    printf "%b" "\0$(((__0__ + ((c + (d / 10000)) % 10))/64))$(((__0__ + ((c + (d / 10000)) % 10))/8%8))$(((__0__ + ((c + (d / 10000)) % 10))%8))"
    c=$((d % 10000))
    k=$((k - 14))
  done

...
#   table_print
#
# Each field is a separate argument, so fields may contain spaces if quoted:
#   table_row "pnut sh" 9171 6133 0.668
#
# Note: a column-internal separator (tab) means empty "" fields are collapsed by
# `column`; pass a placeholder like "-" for missing values.

...
_main() {
  save_loc_var __g2 __g1 f c2 c1
  : $(( c1 = 0 ))
  : $(( c2 = 0 ))
  : $(( f = 0 ))
  defstr __str_0 "six-cc-tests/getchar-interlaced.c"
  _fopen f $__str_0 0
  while { _getchar __g1; [ $((c1 = __g1)) -ne 0 ]; } && { _fgetc __g2 $f; [ $((c2 = __g2)) -ne 0 ]; } && [ $c1 -eq $c2 ] && [ $c1 -ne $_EOF ] ; do
    _putchar __ $c1
  done
  rest_loc_var $1 c1 c2 f __g1 __g2
}

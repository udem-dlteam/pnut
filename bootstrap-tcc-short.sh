...
go() { # $1: name of bootstrap comp, $2: name of new compiler, $3: additional options for TCC
  CC="$1"
  ...
  $CC -c                                                                       \
    ...
    -I $MES_DIR/include                                                        \
    -I $MES_DIR/include/linux/${MES_ARCH}                                      \
    $TEMP_DIR/boot0/unified-libc.c                                             \
    -o $TEMP_DIR/boot0-lib/unified-libc.o
  $CC -ar cr $TEMP_DIR/boot0-lib/libc.a $TEMP_DIR/boot0-lib/unified-libc.o

  # libtcc1.a
  $CC -c -o $TEMP_DIR/boot0-lib/libtcc1.o kit/libtcc1.c
  $CC -ar cr $TEMP_DIR/boot0-lib/tcc/libtcc1.a $TEMP_DIR/boot0-lib/libtcc1.o

...
text comp_fun_call_code(ast node, ast assign_to) {
  ...
  else if (name_id == underscore_EXIT_ID)   { runtime_use__exit = true; }
  else if (name_id == underscore_READ_ID)   { runtime_use__read = true; }
  else if (name_id == underscore_WRITE_ID)  { runtime_use__write = true; }
  else if (name_id == underscore_OPEN_ID)   { runtime_use__open = true; }
  else if (name_id == underscore_CLOSE_ID)  { runtime_use__close = true; }
